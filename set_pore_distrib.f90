...
#   include "control_run.h" ! To control the code to be included in the compilation
    ...
    integer :: iR, aR, i,j 
    real(kind=8) :: shift, denon ! it is  multiplicative factor in probability pro(cuantas)
...
!!         fdis2(iR) = Ka0*Kb0 / denon ! Kb0 = Ka20 for dobule protonation
!BORRAR        print*, "iR, fdis(iR), fdis2(iR): ", iR, fdis(iR), fdis2(iR)
...
# ifdef fdebug_set_pore_distrib
        print*, "set_pore_distrib L95 xpot(i): ", iR, xpot(iR)
#endif
#   ifdef VDW
!**************************************************************
