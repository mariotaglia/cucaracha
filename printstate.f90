...
!    write(1984,'(I6, A24,A14)'), ps_i, " Estado del programa en ", filename  
    ...
    write(1984,*), "xsalt2     :", xsalt2, "pKawall :", pKawall
    write(1984,*), "sigma      :", sigma , "sigmaq  :", sigmaq
    write(1984,*), "kwall      :", kwall , "Kwall0  :", Kwall0
    ...
    write(1984,*), "sigmadelta :", sigmadelta
    write(1984,*), "st         :", st
